...
to-report get-country-trust-level
  let base-level 0
  if country = "Argentina" [ set base-level 22.64706 ]
  if country = "Australia" [ set base-level 54.43383 ]
  if country = "Belarus" [ set base-level 32.80737 ]
  if country = "Brazil" [ set base-level 6.52759 ]
  if country = "China" [ set base-level 62.69384 ]
  if country = "Colombia" [ set base-level 4.12783 ]
  if country = "Germany" [ set base-level 42.03041 ]
  if country = "Ghana" [ set base-level 4.96134 ]
  if country = "India" [ set base-level 32.95383 ]
  if country = "Japan" [ set base-level 35.93942 ]
